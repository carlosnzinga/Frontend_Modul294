...
export class DepartamentDetailComponent implements OnInit {
  ...
  public departamentForm = new FormGroup({
  ...
  ngOnInit(): void {
    if (this.route.snapshot.paramMap.get('id') !== null) {
      ...
      this.tasksService.getOne(id).subscribe(obj => {
        this.task = obj
        this.departamentForm = this.formBuilder.group(this.task)

        this.departamentForm.controls.members.setValue(this.task.members)
      })
    }
